 ...
 * @ORM\Entity(repositoryClass="Acme\EcommerceBundle\Repository\UtilisateurAdresseRepository")
 */
class UtilisateurAdresse
{
     ...
     * @var string
     *
     * @ORM\Column(name="telephone", type="string", length=23, nullable=true)
     */
    private $telephone;
     ...
     * @var float
     *
     * @ORM\Column(name="cp", type="float", nullable=true)
     */
    private $cp;
