...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app_checker' => 'getAppCheckerService',
    ...
    /**
     * Gets the public 'app_checker' shared service.
     *
     * @return \AppBundle\Helper\Checker
     */
    protected function getAppCheckerService()
    {
        return $this->services['app_checker'] = new \AppBundle\Helper\Checker();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symfony_ecomm', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/Acme/EcommerceBundle/Entity'), 1 => ($this->targetDirs[3].'/src/Utilisateur/UtilisateurBundle/Entity')));

        $d = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $d->addDriver($b, 'AppBundle\\Entity');
        $d->addDriver($c, 'Acme\\EcommerceBundle\\Entity');
        $d->addDriver($c, 'Utilisateur\\UtilisateurBundle\\Entity');
        ...
        $e->setEntityNamespaces(array('AppBundle' => 'AppBundle\\Entity', 'AcmeEcommerceBundle' => 'Acme\\EcommerceBundle\\Entity', 'UtilisateurUtilisateurBundle' => 'Utilisateur\\UtilisateurBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_9c6e597bb3b5748054acf58f14fe21827d3a14ebf019741ccb6a4734da160dda');
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => '@FOSUser/Registration/email.txt.twig', 'resetting.template' => '@FOSUser/Resetting/email.txt.twig', 'from_email' => array('confirmation' => array('960gd7@gmail.com' => '960gd7@gmail.com'), 'resetting' => array('960gd7@gmail.com' => '960gd7@gmail.com'))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $l = new \Symfony\Component\Security\Http\HttpUtils($d, $d, '{^https?://%s$}i');

        $m = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($l, array());
        $m->setOptions(array('always_use_default_target_path' => false, 'default_target_path' => '/', 'login_path' => '/login', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        $o = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $l, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($l, '/'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => '/logout'));
        $o->addHandler(new \Symfony\Component\Security\Http\Logout\CsrfTokenClearingLogoutHandler($this->get('security.csrf.token_storage')));
        $o->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($k, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('fos_user.user_provider.username')), 'main', $a, $c), 2 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, $this->get('security.authentication.session_strategy.main'), $l, 'main', $m, $n, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, $this->get('security.csrf.token_manager')), 3 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '6024d907a7ff48.59054741', $a, $f), 4 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $k, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $l, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $l, '/login', false), NULL, NULL, $a, false), $o);
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('960gd7@gmail.com');
        $a->setPassword(NULL);
        $a->setAuthMode(NULL);
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Acme/BlogBundle/Resources/views'), 'Blog');
        $instance->addPath(($this->targetDirs[3].'/src/Acme/TestBundle/Resources/views'), 'AcmeTest');
        $instance->addPath(($this->targetDirs[3].'/src/Acme/EcommerceBundle/Resources/views'), 'AcmeEcommerce');
        $instance->addPath(($this->targetDirs[3].'/src/Utilisateur/UtilisateurBundle/Resources/views'), 'UtilisateurUtilisateur');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'BlogBundle' => 'Acme\\BlogBundle\\BlogBundle',
                'AcmeTestBundle' => 'Acme\\TestBundle\\AcmeTestBundle',
                'AcmeEcommerceBundle' => 'Acme\\EcommerceBundle\\AcmeEcommerceBundle',
                'UtilisateurUtilisateurBundle' => 'Utilisateur\\UtilisateurBundle\\UtilisateurUtilisateurBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'BlogBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Acme/BlogBundle'),
                    'namespace' => 'Acme\\BlogBundle',
                ),
                'AcmeTestBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Acme/TestBundle'),
                    'namespace' => 'Acme\\TestBundle',
                ),
                'AcmeEcommerceBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Acme/EcommerceBundle'),
                    'namespace' => 'Acme\\EcommerceBundle',
                ),
                'UtilisateurUtilisateurBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Utilisateur/UtilisateurBundle'),
            ...
            'database_port' => NULL,
            'database_name' => 'symfony_ecomm',
            'database_user' => 'root',
            'database_password' => 'root',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => '960gd7@gmail.com',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => '960gd7@gmail.com',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                '960gd7@gmail.com' => '960gd7@gmail.com',
            ),
