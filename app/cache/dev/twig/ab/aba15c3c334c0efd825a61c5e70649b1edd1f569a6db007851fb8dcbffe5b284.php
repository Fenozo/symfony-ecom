...
class __TwigTemplate_72d4560d6879072b30627a8f242416ae8036c7550dacbcc6df6aff36a087f463 extends Twig_Template
{
...
";
        ...
        foreach ($context['_seq'] as $context["position"] => $context["e"]) {
            // line 38
            echo "    ";
            $this->loadTemplate("@Twig/Exception/traces.html.twig", "TwigBundle:Exception:exception.html.twig", 38)->display(array("exception" => $context["e"], "position" => $context["position"], "count" => ($context["previous_count"] ?? $this->getContext($context, "previous_count"))));
        }
        $_parent = $context['_parent'];
...
";
        ...
        <div id=\"logs\">
            ";
            // line 64
            $this->loadTemplate("@Twig/Exception/logs.html.twig", "TwigBundle:Exception:exception.html.twig", 64)->display(array("logs" => $this->getAttribute(($context["logger"] ?? $this->getContext($context, "logger")), "logs", array())));
            // line 65
            echo "        </div>
    </div>
";
...
";
        // line 89
        $this->loadTemplate("@Twig/Exception/traces_text.html.twig", "TwigBundle:Exception:exception.html.twig", 89)->display(array("exception" => ($context["exception"] ?? $this->getContext($context, "exception"))));
        // line 90
        echo "
...
//]]></script>
", "TwigBundle:Exception:exception.html.twig", "/var/www/html/github/symfony-2.8/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views/Exception/exception.html.twig");
    }
}
