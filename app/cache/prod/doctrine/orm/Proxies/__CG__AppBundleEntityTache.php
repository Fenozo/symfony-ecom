...
class Tache extends \AppBundle\Entity\Tache implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Tache' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Tache' . "\0" . 'title', '' . "\0" . 'AppBundle\\Entity\\Tache' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\Tache' . "\0" . 'dateDebut', '' . "\0" . 'AppBundle\\Entity\\Tache' . "\0" . 'dateFin', '' . "\0" . 'AppBundle\\Entity\\Tache' . "\0" . 'status'];
        }
